...
for (measure in c("FIRST_FIXATION", "GAZE_DURATION", "TOTAL_FIXATION")){
      ...
      formula1 = "RT ~ English/FREQUENCY_c + English/FREQUENCY_prev1_c + 
                       ...
                       (FREQUENCY_c + SURPRISAL_c + WORD_LEN_c + FREQUENCY_prev1_c + SURPRISAL_prev1_c + WORD_LEN_prev1_c| SUBJECT)"# +(SURPRISAL_c|WORD_NORM)"
      ...
      cat("CELER\n")
      print(run_mixed_effects_julia(filter(celer_ia_oov_long, fix_measure == measure), formula1))
      cat("\n")
      print(run_mixed_effects_julia(filter(celer_ia_oov_long, fix_measure == measure), formula2))
      cat("\n")
      cat("GECO\n")
      print(run_mixed_effects_julia(filter(geco_ia_oov_long, fix_measure == measure), formula1))
      cat("\n")
